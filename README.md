...
If you want to publish the current folder as `castside`:
...
git branch -M main
git remote add origin git@github.com:YOUR_USERNAME/castside.git
...
```bash
git remote add origin https://github.com/YOUR_USERNAME/castside.git
git push -u origin main
```

## Recommended Next Steps

- add a real LICENSE file if you plan to open-source it
- add screenshots or a demo GIF to this README
- add a backend if you want multi-user or hosted deployment
- add a relay/encoder path for direct YouTube publishing
- add tests around settings migration and media mode transitions
